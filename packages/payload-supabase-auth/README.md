...
[full integration guide](https://github.com/dombestein-data/payload-supabase-auth/blob/main/integration.md)
for a production setup checklist and its
[publishing guide](https://github.com/dombestein-data/payload-supabase-auth/blob/main/publish.md)
